	...
	useEffect(() => {
		const fetchData = async () => {
			try {
				...
				await Promise.all([fetchBestSellingProduct(), fetchProductNewest(), fetchtotalRenue(), fetchTotalProductsSoldToday(), fetchStatusProduct(), fetchPageTopTenOrderDetails()]);
			...
			{isLoading ? (
              ...
              flex-md-nowrap align-items-center py-4'>
						<div className='d-block mb-4 mb-md-0'>
							...
							<h3>
								Chào mừng trở lại, <span className='fs-3 fw-bold'>YourAdminName</span>
							</h3>
            ...
            <ButtonGroup>
              ...
              <Button variant="outline-primary" size="sm">Export</Button>
					...
					<div className='container-fluid d-flex justify-content-start gap-3'>
						...
						<div
							...
							<div className='card-body'>
								<h3 className='card-title fw-bold fs-3'>{productNewest.length}</h3>
						...
						<div
							...
							<div className='card-body'>
								<h3 className='card-title fw-bold fs-3'>{totalReneue.toLocaleString('it-IT', {style: 'currency', currency: 'VND'})}</h3>
					...
					<div className='main-content container-fluid mt-4'>
						<div className='row'>
							<h4>
								Tổng Giao dịch trong ngày: <strong>{topTenOrderDetails.length}</strong>
							</h4>
							{/* Item */}
							<div className='col-8'>
														...
														<tbody class='table-group-divider'>
															{topTenOrderDetails.map((o) => (
																<tr key={o.id}>
																	...
																	<td>{o.product.price.toLocaleString('it-IT', {style: 'currency', currency: 'VND'})}</td>
																	<td>{o.price.toLocaleString('it-IT', {style: 'currency', currency: 'VND'})}</td>
																	<td>{o.quantity}</td>
																</tr>
															))}
														</tbody>
