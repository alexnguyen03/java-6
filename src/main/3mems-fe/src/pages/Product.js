...
import {Button, ButtonGroup, Form, Modal, ModalBody, ModalFooter, Toast, ToastBody, ToastHeader} from '@themesberg/react-bootstrap';
		...
		<>
				...
				<Form className='row'>
					...
					<Form.Group className='mb-3 col-6'>
						...
						<Form.Control
							...
							value={productName}
						/>
						<Form.Control.Feedback>Vui lòng nhập tên sản phẩm</Form.Control.Feedback>
					</Form.Group>
					{/* Item */}
					<Form.Group className='mb-3 col-6'>
						...
						<Form.Control
							...
							// value={''}
						/>
						<Form.Control.Feedback>Vui lòng chọn ảnh sản phẩm</Form.Control.Feedback>
					</Form.Group>
					{/* Item */}
					<Form.Group className='mb-3 col-6'>
						...
						<Form.Control
							...
							value={productPrice}
						/>
						<Form.Control.Feedback>Vui lòng nhập giá sản phẩm</Form.Control.Feedback>
					</Form.Group>
					{/* Item */}
					<Form.Group className='mb-3 col-6'>
						...
						<Form.Control
							...
							type='number'
						/>
						<Form.Control.Feedback>Vui lòng chọn số lượng sản phẩm</Form.Control.Feedback>
					</Form.Group>
					{/* Item */}
					<Form.Group className='mb-3 col-6'>
						...
						<Form.Control.Feedback>Vui lòng chọn Danh mục sản phẩm</Form.Control.Feedback>
					</Form.Group>
             ...
             */}
				...
				<Modal
					...
					<Modal.Header>
						<Modal.Title className='h6'>Bạn có chắc chắn muốn xóa: {modalsValue}</Modal.Title>
						<Button
							variant='close'
							aria-label='Close'
					...
					<ModalBody>
						<img
							src={'http://localhost:8080/img/cat-delete.jpg'}
							alt=''
						/>
					</ModalBody>
					<ModalFooter>
