	...
	return (
		<>
			<Row className='mb-3'>
				...
				<Toast onClose={() => setShowToast(false)} show={showToast} autohide className='position-absolute top-0 start-50 translate-middle-x z-3 bg-success'>
					<Toast.Header>
					...
					<>
						<Col xl={12}>
							<Card
								...
								<Card.Body>
									<h5 className='mb-4'>Quản lý danh mục</h5>
									<Form>
										<Row>
											<Col
												md={6}
